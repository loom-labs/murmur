...
///
/// Skipped unless `HUGO_INTEGRATION=1`. These pass locally in under a second
...
///
///     HUGO_INTEGRATION=1 swift test --filter ScreenTextRecognitionTests
@Suite(
...
struct ScreenTextRecognitionTests {
    ...
    func recognizesRenderedText() async throws {
        let expected = "Hugo reads the screen"
