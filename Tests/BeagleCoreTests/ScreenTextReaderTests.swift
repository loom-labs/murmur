...
///
/// Skipped unless `BEAGLE_INTEGRATION=1`. These pass locally in under a second
...
///
///     BEAGLE_INTEGRATION=1 swift test --filter ScreenTextRecognitionTests
@Suite(
...
struct ScreenTextRecognitionTests {
    ...
    func recognizesRenderedText() async throws {
        let expected = "Beagle reads the screen"
