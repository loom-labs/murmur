#!/usr/bin/env bash
#
# Build Hugo.app and wrap it in a distributable DMG.
#
# Produces dist/Hugo-<version>-arm64.dmg containing the app and a symlink to
...
# notarized, so Gatekeeper refuses the first launch and users need the
# quarantine command to get past it.
...
https://github.com/loom-labs/hugo
NOTE
