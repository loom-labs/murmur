...
public enum Hugo {
    ...
    public static let appName = "Hugo"
    ...
    public static let bundleIdentifier = "ai.loomlabs.hugo"
    ...
    /// `~/Library/Application Support/Hugo`, created on first access.
    ///
    ...
    ///
    /// This is FluidAudio's own default, and Hugo deliberately does not
