...
/// The floating orb: Beagle's entire on-screen footprint.
///
...
public struct OrbView: View {
    ...
    private let style: BeagleCore.Settings.OrbStyle
    ...
    public init(
        ...
        style: BeagleCore.Settings.OrbStyle = .beagle,
    ...
    public var body: some View {
        ZStack {
            ...
            switch style {
            case .beagle:
                // Always animated: he blinks at rest, which is what makes the
                // orb feel like a companion rather than a status light.
            ...
            case .classic:
                // One timeline drives every animated state, so the view redraws
        ...
        .help(helpText)
        .accessibilityLabel(Beagle.appName)
...
// that ships with Xcode, and Beagle is built with the Command Line Tools
