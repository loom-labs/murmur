...
/// The system permissions Beagle needs, and how to ask for them.
///
...
public enum Permission: String, CaseIterable, Sendable {
    ...
    /// Why Beagle needs it, in the user's terms.
    public var rationale: String {
        switch self {
        case .microphone:
            return "So Beagle can hear you when you dictate."
        case .accessibility:
            return "So Beagle can paste transcripts at your cursor and read your selection."
        case .screenRecording:
            return "So Beagle can read text from a region of your screen."
        }
    }
