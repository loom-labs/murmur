...
public enum Beagle {
    ...
    public static let appName = "Beagle"
    ...
    public static let bundleIdentifier = "ai.loomlabs.beagle"
    ...
    /// `~/Library/Application Support/Beagle`, created on first access.
    ///
    ...
    ///
    /// This is FluidAudio's own default, and Beagle deliberately does not
