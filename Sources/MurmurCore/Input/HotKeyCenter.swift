...
/// permission, it cannot drop events under load, and it does not put Murmur in
...
public final class HotKeyCenter {
    ...
    /// Four-character signature identifying Murmur's hotkeys to Carbon.
    ...
    /// Release every shortcut Murmur holds.
