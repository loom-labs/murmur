...
/// The system permissions Murmur needs, and how to ask for them.
///
...
public enum Permission: String, CaseIterable, Sendable {
    ...
    /// Why Murmur needs it, in the user's terms.
    public var rationale: String {
        switch self {
        case .microphone:
            return "So Murmur can hear you when you dictate."
        case .accessibility:
            return "So Murmur can paste transcripts at your cursor and read your selection."
        case .screenRecording:
            return "So Murmur can read text from a region of your screen."
        }
    }
