...
public struct SettingsView: View {
    ...
    @Bindable private var controller: HugoController

    public init(controller: HugoController) {
...
private struct GeneralSettings: View {
    ...
    @Bindable var controller: HugoController
    ...
    var body: some View {
        Form {
            Section {
                ...
                Text("Hugo asks for each of these the first time you use the feature that needs it.")
                    .textCase(nil)
            }
...
private struct ModelSettings: View {
    ...
    var body: some View {
        Form {
            ...
            Section("Storage") {
                ...
                Text(Hugo.modelsDirectory().path)
                    .font(.caption)
                    .foregroundStyle(.secondary)
            ...
            Section {
                LabeledContent("Hugo", value: Hugo.version)
            }
        }
        .formStyle(.grouped)
    }
    ...
    private var cacheSize: String {
        let bytes = Hugo.cachedModelBytes()
