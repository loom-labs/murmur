...
final class AppDelegate: NSObject, NSApplicationDelegate {
    ...
    func applicationDidFinishLaunching(_ notification: Notification) {
        ...
        // is typing in — which is the app Beagle is about to paste into.
        ...
        Log.app.info("Beagle \(Beagle.version, privacy: .public) launched")
    }
    ...
    private func showOrb(for controller: BeagleController) {
    ...
    private func observeOrbPreference(_ controller: BeagleController) {
    ...
    func showSettings() {
        ...
        window.title = "\(Beagle.appName) Settings"
